...
2. Simak tantangan berikut lalu kerjakan secara berkelompok`
  ...
  const checkSectionDAnswer = (field, value) => {
    const correctAnswers = {
      ...
      lemah: 'Jika titik-titik masih memperlihatkan arah tertentu tetapi tersebar cukup jauh dari garis kecenderungannya, korelasinya disebut lemah. Hubungannya masih ada, tetapi tidak terlalu kuat. | Nilai korelasi: mendekati 0.3-0.5 (misalnya 0.4)',
